function makeChoice(choice) {
    ...
    if (choice === 'enter') {
        ...
        choices.innerHTML = '<button onclick="makeChoice("investigate")">Investigate the sound</button' // A1
                            '<button onclick="makeChoice("explore")">Explore the tree</button>'; // A2
    // A1 Options Return
        ...
        choices.innerHTML = '<button onclick="makeChoice("help")">Help the creature</button>' // A1a
                            '<button onclick="makeChoice("run")">Run away</button>'; // A1b
    ...
    // A2 Options Return                   
        ...
        choices.innerHTML = '<button onclick="makeChoice("talkowl")">Talk to the Owl</button>' // A2a
                            '<button onclick="makeChoice("examinepotions")">Examine the potions</button>'; //A2b
    // A1a Options Return                        
    } else if (choice === 'help') {
        ...
        choices.innerHTML = '<button onclick="makeChoice("wishsecrets")">Wish for knowledge of the forests secrets</button>' // A1a1
                            '<button onclick="makeChoice("wishanimals")">Wish for the ability to communicate with animals</button>'; // A1a2
    ...
    // A1b Options Return                        
        ...
        choices.innerHTML = '<button onclick="makeChoice("apologize")">Apologize and explain your fear</button>' // A1b1
                            '<button onclick="makeChoice("keeprunning")">Keep running</button>'; // A1b2
