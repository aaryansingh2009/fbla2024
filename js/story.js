...
function resetStory() {
    ...
    storyText.textContent = '• You will be given a scenerio and read thoroughly • There will be 2 choices each taking you to a different path \n • Choose one of the choices \n • Feel free to stop by clicking the "STOP" button <br>';
